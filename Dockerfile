...
RUN echo y | lpkg install linux grub-bios linit linit-modules-load dhcpcd eudev xf86-video-vesa xf86-video-intel intel-dri xf86-input-libinput lxde-core lxdm swrast-dri mesa-demos && \
